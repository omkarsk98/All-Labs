...
void main()
{
  ...
  //int t1[100];
  // int t1[] = {a[1][0],a[1][1],a[2][0],a[2][1],a[3][0],a[3][1],a[1][0],a[1][1]};

  for (i = 0; i < 70; i++)
  {
    line(0, 400, 640, 400);
    // houses
    rectangle(540 - (0.5 * i), 380, 580 - (0.5 * i), 350);
    rectangle(580 - (0.5 * i), 380, 640 - (0.5 * i), 350);
    line(560 - (0.5 * i), 330, 580 - (0.5 * i), 350);
    line(560 - (0.5 * i), 330, 540 - (0.5 * i), 350);
    line(620 - (0.5 * i), 330, 560 - (0.5 * i), 330);
    line(620 - (0.5 * i), 330, 640 - (0.5 * i), 350);

    rectangle(520 - (0.5 * i), 380, 460 - (0.5 * i), 350);
    rectangle(420 + 40 - (0.5 * i), 380, 380 + 40 - (0.5 * i), 350);
    line(400 - (0.5 * i) + 40, 330, 420 - (0.5 * i) + 40, 350);
    line(400 - (0.5 * i) + 40, 330, 380 - (0.5 * i) + 40, 350);
    line(400 - (0.5 * i) + 40, 330, 460 - (0.5 * i) + 40, 330);
    line(460 - (0.5 * i) + 40, 330, 480 - (0.5 * i) + 40, 350);
    //Aircraft structure
  ...
  {
    // houses
    rectangle(500 - (0.5 * i) + 110 - 35, 380, 540 - (0.5 * i) + 110 - 35, 350);
    rectangle(540 - (0.5 * i) - 35 + 110, 380, 600 - (0.5 * i) - 35 + 110, 350);
    line(520 - (0.5 * i) - 35 + 110, 330, 540 - (0.5 * i) - 35 + 110, 350);
    line(520 - (0.5 * i) + 110 - 35, 330, 500 - (0.5 * i) + 110 - 35, 350);
    line(580 - (0.5 * i) + 110 - 35, 330, 520 - (0.5 * i) + 110 - 35, 330);
    line(580 - (0.5 * i) - 35 + 110, 330, 600 - (0.5 * i) - 35 + 110, 350);

    rectangle(480 - (0.5 * i) - 35 + 110, 380, 420 - (0.5 * i) - 35 + 110, 350);
    rectangle(420 - (0.5 * i) - 35 + 110, 380, 380 - (0.5 * i) - 35 + 110, 350);
    line(400 - (0.5 * i) - 35 + 110, 330, 420 - (0.5 * i) - 35 + 110, 350);
    line(400 - (0.5 * i) - 35 + 110, 330, 380 - (0.5 * i) - 35 + 110, 350);
    line(400 - (0.5 * i) - 35 + 110, 330, 460 - (0.5 * i) - 35 + 110, 330);
    line(460 - (0.5 * i) - 35 + 110, 330, 480 - (0.5 * i) - 35 + 110, 350);
